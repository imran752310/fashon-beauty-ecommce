    ...
    <div className="my-10 px-4">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-2/3">
          <div className="bg-[url('/images/banner-1.jpg')] bg-cover bg-center w-full h-[300px] sm:h-[400px] md:h-[450px]">
        ...
        <div className="w-full md:w-1/3">
          <div className="bg-[url('/images/banner-2.jpg')] bg-cover bg-center w-full h-[300px] sm:h-[400px] md:h-[450px]">
            <div className="w-[90%] h-full mx-auto flex flex-col justify-center space-y-4 p-6 sm:p-10">
              <h1 className="text-2xl sm:text-4xl md:text-5xl font-Urbanist leading-tight text-black">
                25% off Everything
              </h1>
