...
//               <button   onClick={() => addToCart(product)}  className="flex gap-x-2 px-3 bg-black hover:bg-[#4e7460] text-white p-3 rounded-md">
//                 <span>Add To Cart</span>
//                 <FaShoppingCart className="w-5 h-5" />
//               </button>
//               <button className="flex gap-x-2 px-3 border hover:bg-[#4e7460] hover:text-white p-3 rounded-md">
//                 <span>Checkout</span>
//               </button>
//             </div>
